...
export async function checkFirstRunConsent(consentPath, isCI = false) {
  // Skip consent in CI environments
  if (isCI) {
    console.log(`${CYAN}🤖 CI environment detected - auto-consenting to YOLT mode${RESET}`);
    return true;
  }
